// Generated with bin/trans-dump at 2019-04-15 18:05:12 UTC
package oyun.i18n
...
def untranslated(message: String) = new Untranslated(message)
  ...
  val `freeOnlineOkeyGamePlayOkeyNowInACleanInterfaceNoRegistrationNoAdsNoPluginRequiredPlayOkeyWithComputerFriendsOrRandomOpponents` = new Translated("freeOnlineOkeyGamePlayOkeyNowInACleanInterfaceNoRegistrationNoAdsNoPluginRequiredPlayOkeyWithComputerFriendsOrRandomOpponents", Site)
