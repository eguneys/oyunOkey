// Generated with bin/trans-dump at 2019-04-14 01:48:58 UTC
package oyun.i18n
...
final class I18nKeys(translator: Translator) {
  ...
  val `sortSeries` = new Key("sortSeries")
  val `sortPairs` = new Key("sortPairs")
