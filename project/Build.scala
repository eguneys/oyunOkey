...
//   lazy val game = project("game", Seq(common, db, user, chat)).settings(
...
//   lazy val fishnet = project("fishnet", Seq(common, game, db)).settings(
//     libraryDependencies ++= provided(play.api, RM)
//   )

//   lazy val round = project("round", Seq(common, user, chat, game, socket, hub, fishnet)).settings(
//     libraryDependencies ++= provided(play.api, play.test, RM)
//   )

//   lazy val lobby = project("lobby", Seq(common, user, game, socket, hub)).settings(
//     libraryDependencies ++= provided(play.api, RM)
//   )
...
//     libraryDependencies ++= Seq(spray.caching, scaffeine) ++ provided(play.api, play.test, RM)
//   )
