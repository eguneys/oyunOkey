...
private object `$locale` {
  ...
  def load: java.util.HashMap[oyun.i18n.MessageKey, oyun.i18n.Translation] = {
    val m = new java.util.HashMap[oyun.i18n.MessageKey, oyun.i18n.Translation](${content.size + 1}, 1f)
${content mkString "\n"}
    m
  }
}
