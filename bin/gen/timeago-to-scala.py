...
def uglifyjs(js):
    p = subprocess.Popen(["npx", "terser", "--compress", "--mangle"], stdin=subprocess.PIPE, stdout=subprocess.PIPE, stderr=sys.stderr)
...
def postprocess(js):
    return "(function(){" + js.replace("module.exports=", "oyunkeyf.timeagoLocale=") + "})()"
